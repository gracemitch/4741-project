...
integer_encoded2 = label_encoder2.fit_transform(season)
# binary encode
...
wdf=pd.DataFrame({'offset':offset,'drytemp':drytemp_s,'dewtemp':dewtemp_s,'humidity':humidity_s,'wind speed':wind_s,'precip':precip_s,'TOD1':TOD1,'TOD2':TOD2,'TOD3':TOD3,'TOD4':TOD4,'TOD5':TOD5,'Season1':season1,'Season2':season2,'Season3':season3,'Season4':season4,'Day1':dayf1,'Day2':dayf2})                                                   
...
# shuffle and split to training and test: 6970 goes to training/1742 to test
...
# split
court_train=court_rand[:6970]
court_test=court_rand[6970:]
# export to csv
...
# split
office_train=office_rand[:6970]
office_test=office_rand[6970:]
# export to csv
...
# split
school1_train=school1_rand[:6970]
school1_test=school1_rand[6970:]
# export to csv
...
# split
school2_train=school2_rand[:6970]
school2_test=school2_rand[6970:]
# export to csv
