...
# create new data frame
courtdf=pd.DataFrame({'PDemand Feature':courty_stan,'Courthouse y':court_y})
# export 
...
# create new data frame
officedf=pd.DataFrame({'PDemand Feature':officey_stan,'Office y':office_y})
# export 
...
# create new data frame
school1df=pd.DataFrame({'PDemand Feature':school1y_stan,'School1 y':school1_y})
# export 
...
# create new data frame
school2df=pd.DataFrame({'PDemand Feature':school2y_stan,'School2 y':school2_y})
# export 
...
# split
office_train=office_rand[:5227]
office_valid=office_rand[5228:6970]
office_test=office_rand[6971:]
# export to csv
...
# split
school1_train=school1_rand[:5227]
school1_valid=school1_rand[5228:6970]
school1_test=school1_rand[6971:]
# export to csv
...
# split
school2_train=school2_rand[:5227]
school2_valid=school2_rand[5228:6970]
school2_test=school2_rand[6971:]
# export to csv
